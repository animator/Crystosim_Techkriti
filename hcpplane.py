...
def drawhc(s,u,v,t,w):
   ...
   # print lh
    ...
    if(u==0 and v==0 and t==0):
       ...
       drawborder1(list0,list1,list2,list3)
       drawborder1(list2,list3,list4,list5)
       return
    hcf1=hcfa(abs(u),abs(v))
    hcf2=hcfa(abs(v),abs(w))
    hcf=min(hcf1,hcf2)
    #print hcf
    w=w/hcf
    u=u/hcf
    ...
    if (w==0):
        ...
        if(t==0 and (u !=0 and v!=0)):
           ...
           # faces(pos=[(px1,py1,0),(px2,py2,0),(px2,py2,4)],color=color.blue)
            ...
            drawborder1((px1,py1,0),(px2,py2,0),(px2,py2,4),(px1,py1,4))
    ...
    if(w!=0):
            ...
            if(u!=0  and t!=0):
                ...
                drawborder((px1,py1,0),(px3,py3,0),(0,0,pz4))
                return
            if(v!=0 and t!=0):
                convex(pos=[(px2,py2,0),(px3,py3,0),(0,0,pz4)],color=color.red)
                drawborder((px2,py2,0),(px3,py3,0),(0,0,pz4))
                return
            convex(pos=[(px1,py1,0),(px2,py2,0),(0,0,pz4)],color=color.red)
            drawborder((px1,py1,0),(px2,py2,0),(0,0,pz4))
