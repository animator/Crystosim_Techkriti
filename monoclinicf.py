...
class ExamplePanel(wx.Frame):
    def __init__(self, parent,id,title):
        ...
        self.sampleList = ['primitive','end centered']
        ...
        self.lblname5 = wx.StaticText(panel, label="beta", pos=(20,190))
        self.editname5 = wx.TextCtrl(panel, value="90", pos=(150, 190), size=(140,-1),style=wx.TE_PROCESS_ENTER)
        ...
        self.lblname7 = wx.StaticText(panel, label="percentage :", pos=(20,220))
        self.editname7 = wx.TextCtrl(panel, value="50", pos=(150, 220), size=(140,-1),style=wx.TE_PROCESS_ENTER)
        #self.Bind(wx.EVT_TEXT_ENTER, self.EvtChar5, self.editname5)
        self.lblname8 = wx.StaticText(panel, label="l", pos=(20,250))
        self.editname8 = wx.TextCtrl(panel, value="1", pos=(150, 250), size=(140,-1),style=wx.TE_PROCESS_ENTER)
        self.lblname9= wx.StaticText(panel, label="w", pos=(20,280))
        self.editname9 = wx.TextCtrl(panel, value="1", pos=(150, 280), size=(140,-1),style=wx.TE_PROCESS_ENTER)
        self.lblname10 = wx.StaticText(panel, label="h", pos=(20,310))
        self.editname10 = wx.TextCtrl(panel, value="1", pos=(150, 310), size=(140,-1),style=wx.TE_PROCESS_ENTER)
                #the control button
        self.button =wx.Button(panel, label="OK", pos=(30, 375))
