...
class ExamplePanel(wx.Frame):
    def __init__(self, parent,id,title):
        ...
        self.lblname5 = wx.StaticText(panel, label="percentage :", pos=(20,190))
        self.editname5 = wx.TextCtrl(panel, value="50", pos=(150, 190), size=(140,-1),style=wx.TE_PROCESS_ENTER)
        #self.Bind(wx.EVT_TEXT_ENTER, self.EvtChar5, self.editname5)
        self.lblname6 = wx.StaticText(panel, label="l", pos=(20,220))
        self.editname6 = wx.TextCtrl(panel, value="1", pos=(150, 220), size=(140,-1),style=wx.TE_PROCESS_ENTER)
        self.lblname7= wx.StaticText(panel, label="w", pos=(20,250))
        self.editname7 = wx.TextCtrl(panel, value="1", pos=(150, 250), size=(140,-1),style=wx.TE_PROCESS_ENTER)
        ...
        self.editname8 = wx.TextCtrl(panel, value="1", pos=(150, 280), size=(140,-1),style=wx.TE_PROCESS_ENTER)
                #the control button
        self.button =wx.Button(panel, label="OK", pos=(30, 335))
